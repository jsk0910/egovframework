...
<div id="container" class="container">
	...
	<div id="body" class="container-fluid">
		...
		<div id="body-main" class="container text-center">
			<form id="registerNew" action="insertNew.do" method="post" class="was-validated" novalidate>
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td>
								<div class="input-group has-validation">
									<input id="title" type="text" placeholder="제목을 입력하세요" name="title" class="form-control" required/>
						...
						<tr>
							<th>이름</th>
							<td>
								<input id="name" type="text" placeholder="이름(아이디)을 입력하세요" name="name" class="form-control" required/>
								<div class="invalid-feedback">입력해주세요</div>
								<div class="valid-feedback">done!</div>
							</td>
						</tr>
						<tr>
							<th>내용</th>
							<td>
								<textarea id="content" type="text" placeholder="내용을 입력하세요" name="content" class="form-control" style="height:200px;" required ></textarea>
								<div class="invalid-feedback">입력해주세요</div>
								<div class="valid-feedback">done!</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="input-group">
									<input id="fileName" type="file" class="form-control" name="uploadFile">
								</div>
						</tr> -->
						<tr>
							<td colspan="2">
